...
public class PlayerController : MonoBehaviour {
    ...
    void Start()
    {
        //mainCamera = (GameObject)GameObject.FindWithTag("MainCamera"); //finds the camera object
    }

    void Update()
    {

        //mainCamera.transform.position = new Vector2(transform.position.x, transform.position.y); //Moves the camera to follow player
